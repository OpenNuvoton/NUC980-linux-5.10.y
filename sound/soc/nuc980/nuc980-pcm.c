...
static int nuc980_dma_hw_params(struct snd_soc_component *component,
...
static int nuc980_dma_hw_free(struct snd_soc_component *component,
		       struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct nuc980_audio *nuc980_audio = runtime->private_data;
...
static int nuc980_dma_prepare(struct snd_soc_component *component,
		       struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct nuc980_audio *nuc980_audio = runtime->private_data;
...
static snd_pcm_uframes_t nuc980_dma_pointer(struct snd_soc_component *component,
		struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	dma_addr_t src, dst;
...
static int nuc980_dma_open(struct snd_soc_component *component,
		    struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
static int nuc980_dma_close(struct snd_soc_component *component,
		     struct snd_pcm_substream *substream)
{
	return 0;
}
...
static int nuc980_dma_mmap(struct snd_soc_component *component,
		    struct snd_pcm_substream *substream,
...
static void nuc980_dma_free_dma_buffers(struct snd_soc_component *component,
			     struct snd_pcm *pcm)
{
...
static int nuc980_dma_new(struct snd_soc_component *component,
...
struct snd_soc_component_driver nuc980_asrc_component = {
	.name		= DRV_NAME,
	.pcm_construct	= nuc980_dma_new,
	.pcm_destruct	= nuc980_dma_free_dma_buffers,
